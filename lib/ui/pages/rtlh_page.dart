...
class RtlhPage extends StatefulWidget with NavigationStates {
  final Function onMenuTap;

  const RtlhPage({Key key, this.onMenuTap}) : super(key: key);
              ...
              children: [
                Row(
                  ...
                  children: [
                    ...
                    Text("RTLH", style: TextStyle(fontSize: 24, color: Colors.black)),
                    Icon(Icons.settings, color: Colors.black),
                  ],
                ),
                SizedBox(height: 20),
                PaginatedDataTable(
                  header: Text('Data RTLH'),
                  rowsPerPage: 10,
                  columns: [
                    DataColumn(label: Text('Kabupaten')),
                    DataColumn(label: Text('Kelurahan')),
                    DataColumn(label: Text('RLH')),
                    DataColumn(label: Text('RTLH')),
                  ],
